		...
		document.getElementById ("loader").style.visibility = "hidden";
	            ...
	            document.getElementById("txt_1").value = getSavedValue("name");    // set the value to this input
        document.getElementById("txt_2").value = getSavedValue("email");   // set the value to this input
